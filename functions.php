...
function portfolio_scripts() {
	...
	wp_register_style( 'main-css', get_template_directory_uri() . '/css/main.css', array(), '0.0.1','all' );
	wp_enqueue_style( 'main-css' );
	
	wp_register_style( 'extra-css', get_template_directory_uri() . '/css/extra.css', array(), '0.0.1','all' );
	wp_enqueue_style( 'extra-css' );

	wp_enqueue_style('google_fonts', 'https://fonts.googleapis.com/css?family=Cabin|Inconsolata|Nunito|Nunito+Sans|Pacifico|Quicksand|Rubik|VT323');
...
function portfolio_footer_scripts()
{
...
add_action('wp_footer','portfolio_footer_scripts');
